...
python3 zap-full-scan.py -t http://frontend:80 -z "auth.header=Authorization:\ Bearer\ $TOKEN" -r report/full-report-authenticated.html -J report/full-report-authenticated.json -d
